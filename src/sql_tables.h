#ifndef SHARE_BIKE_SQL_TABLES_H
#define SHARE_BIKE_SQL_TABLES_H
...
public:
    ...
    bool CreateUserInfo() {
        LOG_DEBUG("正在创建用户信息表......");
        const char *pUserInfoTable = "CREATE TABLE IF NOT EXISTS userinfo("
    ...
    bool CreateBikeTable() {
        LOG_DEBUG("正在创建单车信息表......");
        const char *pBikeInfoTable = "CREATE TABLE IF NOT EXISTS bikeinfo("
